...
## Description
[![Build Status](https://ci.deis.cc/job/fluentd/badge/icon)](https://ci.deis.cc/job/fluentd)
...
This work is based on the [docker-fluentd](https://github.com/fabric8io/docker-fluentd) and [docker-fluentd-kubernetes](https://github.com/fabric8io/docker-fluentd-kubernetes) images by the fabric8 team. This image is in with [deis](https://github.com/deiscc/deis) v2 to send all log data to the [logger](https://github.com/deiscc/logger) component.
